        ...
        <>
            <form>
                    ...
                    <div className="border-b border-white/10 pb-12">
                        <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-5">
                            <div className="sm:col-span-5">
                                ...
                                <div className="mt-2">
                                    <input id="username" type="text" name="username" autoComplete="given-name" className="block w-full rounded-md bg-white/5 px-3 py-1.5 text-base text-white outline-1 -outline-offset-1 outline-white/10 placeholder:text-gray-500 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-500 sm:text-sm/6" />
                                </div>
                            </div>
                            <div className="sm:col-span-5">
                ...
                <div className="mt-6 flex items-center justify-center gap-x-6">
                    ...
                    <button type="submit" className="rounded-md bg-indigo-500 px-3 py-2 text-sm font-semibold text-white focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500 cursor-pointer">Log in</button>
                </div>
                <div className="mt-5">
                    <p className="text-sm/8">Don't have an account? <Link to="/register" className="text-white hover:text-gray-500 font-bold">Register</Link></p>
                </div>
            </form>
